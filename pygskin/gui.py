...
class Widget(ecs.Entity, Sprite):
    def __init__(self, **kwargs) -> None:
        ...
        self.style.setdefault("background", (0, 0, 0, 0))
    ...
    def draw(self, surface: Surface) -> None:
        surface.fill(self.style.get("background", "grey"))
...
class Container(Widget):
    ...
    def draw(self, surface: Surface) -> None:
        ...
        if self.rect:
            self.layout(
                self.rect,
                cast(LayoutItems, self.children),
...
class Label(Widget):
    ...
    def draw(self, surface: Surface) -> None:
        ...
        if self.rect:
            ...
            surface.fill(self.style.get("background", (0, 0, 0, 0)))
